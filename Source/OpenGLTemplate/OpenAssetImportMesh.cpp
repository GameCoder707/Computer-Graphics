...
void COpenAssetImportMesh::SetPos(glm::vec3 pos)
{
	meshPos = pos;
}

glm::vec3 COpenAssetImportMesh::GetPos()
{
	return meshPos;
}

void COpenAssetImportMesh::SetRotation(glm::mat4 mat)
{
	meshRotMat = mat;
}

glm::mat4 COpenAssetImportMesh::GetRotationMatrix()
{
	return meshRotMat;
}

float COpenAssetImportMesh::GetRotation()
{
	return meshRotDeg;
}

void COpenAssetImportMesh::SetRenderState(bool state)
{
	canRender = state;
}

bool COpenAssetImportMesh::GetRenderState()
{
	return canRender;
}